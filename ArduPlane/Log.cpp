...
{
    uint16_t distance = 0;
    if (rangefinder.status(ROTATION_PITCH_270) == RangeFinder::RangeFinder_Good) {
        distance = rangefinder.distance_cm(ROTATION_PITCH_270);
    }
    ...
    struct log_Sonar pkt = {
        ...
        voltage     : rangefinder.voltage_mv(ROTATION_PITCH_270)*0.001f,
