...
RangeFinder::RangeFinder_Status RangeFinder::status(enum Rotation orientation) const
{
    uint8_t i;
...
uint16_t RangeFinder::distance_cm(enum Rotation orientation) const
{
    uint8_t i;
    if (find_instance(orientation, i)) {
...
uint16_t RangeFinder::voltage_mv(enum Rotation orientation) const
{
    uint8_t i;
    if (find_instance(orientation, i)) {
        return voltage_mv(i);
...
int16_t RangeFinder::max_distance_cm(enum Rotation orientation) const
{
    uint8_t i;
    if (find_instance(orientation, i)) {
...
int16_t RangeFinder::min_distance_cm(enum Rotation orientation) const
{
    uint8_t i;
    if (find_instance(orientation, i)) {
...
int16_t RangeFinder::ground_clearance_cm(enum Rotation orientation) const
{
    uint8_t i;
    if (find_instance(orientation, i)) {
...
bool RangeFinder::has_data(enum Rotation orientation) const
{
    uint8_t i;
    if (find_instance(orientation, i)) {
        return has_data(i);
...
uint8_t RangeFinder::range_valid_count(enum Rotation orientation) const
{
    uint8_t i;
    if (find_instance(orientation, i)) {
...
const Vector3f &RangeFinder::get_pos_offset(enum Rotation orientation) const
{
    uint8_t i=0;
    if (find_instance(orientation, i)) {
        return get_pos_offset(i);
    }
    return get_pos_offset(0);
}
